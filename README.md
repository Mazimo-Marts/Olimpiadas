...
2. **Mágica acontece:** A aplicação vasculha um banco de dados gigantes (`sqn`) (que está no arquivo `dados.js`) e procura por tudo que tenha a ver com o que você digitou.
